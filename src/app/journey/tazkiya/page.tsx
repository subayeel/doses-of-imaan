...
const MindfullnessJourney = () => {
  return (
    <div className="relative flex flex-col items-center justify-start w-full pb-24">
      {/* Header */}
      <header className="max-w-4xl pt-4 border-b w-full mx-auto px-6">
      ...
      <article className="max-w-4xl mx-auto px-6 py-4">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-medium text-amber-800 dark:text-amber-200 flex items-center gap-2">
                  Spiritual Journey{" "}
                  <Link href="/journey/spiritual">
                    {" "}
                    <LinkIcon className="text-primary" size={16} />
                  </Link>
                </h4>
                <p className="text-sm text-amber-600 dark:text-amber-400">
                  Complete Spiritual Journey to understand why Islam is the
                  answer to Objective morality.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-medium text-amber-800 dark:text-amber-200 flex items-center gap-2">
                  Religious Journey{" "}
                  <Link href="/journey/religious">
                    {" "}
                    <LinkIcon className="text-primary" size={16} />
                  </Link>
                </h4>
                <p className="text-sm text-amber-600 dark:text-amber-400">
                  Complete Religious Journey to get deeper understanding of
        ...
        >
          <h3 className="text-primary text-lg flex gap-4 items-center font-semibold mb-4">
            <span>
          ...
          <p className="mb-4 text-primary">
            To master your inner self and become the best version of yourself
            through Islamic spiritual psychology.
          </p>
        </section>
...
export default MindfullnessJourney;
