                ...
                <CardContent className="pt-4 space-y-4">
                  ...
                  <div className="bg-blue-50 dark:bg-blue-900/30 p-4 rounded-lg mt-2">
                    ...
                    <p className="italic mb-2">
                      "And seek help through patience and prayer, and indeed, it
                  ...
                  <div className="bg-blue-50 dark:bg-blue-900/30 p-4 rounded-lg mt-2">
                    ...
                    <ul className="list-disc pl-5 space-y-2">
                      ...
                      <li>
                        If you miss a prayer, make it up as soon as you remember
                      </li>
                      <li>
                        Try to pray at least some prayers in congregation at the
                        masjid
                      </li>
                    </ul>
                  </div>
            ...
            <section id="religious-company" className="scroll-mt-20">
              <Card className={`border-l-4 border-purple-500`}>
                ...
                <CardContent className="pt-4 space-y-4">
                  ...
                  <div>
                    <div className="bg-purple-50 dark:bg-purple-900/30 p-4 rounded-lg mt-2">
                      <h3 className="font-medium mb-2">From the Quran:</h3>
                      <p className="italic mb-2">
            ...
            <section id="fasting" className="scroll-mt-20">
              <Card className={`border-l-4 border-amber-500`}>
                ...
                <CardContent className="pt-4 space-y-4">
                  ...
                  <div>
                    <div className="bg-amber-50 dark:bg-amber-900/30 p-4 rounded-lg mt-2">
                      <h3 className="font-medium mb-2">From the Quran:</h3>
                      <p className="italic mb-2">
            ...
            <section id="death-awareness" className="scroll-mt-20">
              <Card className={`border-l-4 border-gray-500`}>
                ...
                <CardContent className="pt-4 space-y-4">
                  ...
                  <div defaultValue="quran">
                    <div className="bg-gray-50 dark:bg-gray-900/30 p-4 rounded-lg mt-2">
                      <h3 className="font-medium mb-2">From the Quran:</h3>
                      <p className="italic mb-2">
            ...
            <section id="quran-recitation" className="scroll-mt-20">
              <Card className={`border-l-4 border-green-500`}>
                ...
                <CardContent className="pt-4 space-y-4">
                  ...
                  <div defaultValue="quran">
                    <div className="bg-green-50 dark:bg-green-900/30 p-4 rounded-lg mt-2">
                      <h3 className="font-medium mb-2">From the Quran:</h3>
                      <p className="italic mb-2">
            ...
            <section id="dhikr" className="scroll-mt-20">
              <Card className={`border-l-4 border-rose-500`}>
                ...
                <CardContent className="pt-4 space-y-4">
                  ...
                  <div defaultValue="quran">
                    <div className="bg-rose-50 dark:bg-rose-900/30 p-4 rounded-lg mt-2">
                      <h3 className="font-medium mb-2">From the Quran:</h3>
                      <p className="italic mb-2">
            ...
            <section id="knowledge" className="scroll-mt-20">
              <Card className={`border-l-4 border-cyan-500`}>
                ...
                <CardContent className="pt-4 space-y-4">
                  ...
                  <div>
                    <div className="bg-cyan-50 dark:bg-cyan-900/30 p-4 rounded-lg mt-2">
                      <h3 className="font-medium mb-2">From the Quran:</h3>
                      <p className="italic mb-2">
            ...
            <section id="sabr" className="scroll-mt-20">
              <Card className={`border-l-4 border-yellow-500`}>
                ...
                <CardContent className="pt-4 space-y-4">
                  ...
                  <div defaultValue="quran">
                    <div className="bg-yellow-50 dark:bg-yellow-900/30 p-4 rounded-lg mt-2">
                      <h3 className="font-medium mb-2">From the Quran:</h3>
                      <p className="italic mb-2">
        ...
        <footer className="bg-gray-100 dark:bg-gray-800 py-8 mt-12">
          <div className="max-w-7xl mx-auto px-4 text-center">
            ...
            <div className="bg-teal-50 dark:bg-teal-900/30 p-4 rounded-lg max-w-lg mx-auto mt-6">
              ...
              <p className="mt-2 text-gray-700 dark:text-gray-300">
                "O Allah, I ask You for faith that does not waver, blessings
                that do not diminish, and the companionship of our Prophet
                Muhammad ﷺ in the highest level of eternal Paradise."
              </p>
